...
import FinansLogo from '../assets/icon/finans_logo.svg';
...
import XpBankingLogo from '../assets/icon/xp_banking_logo.svg';
...
export const FINANS_LOGO_SVG_URL = LOCAL_SVG_SCHEMA + 'finans_logo';
...
export const XP_BANKING_LOGO_SVG_URL = LOCAL_SVG_SCHEMA + 'xp_banking_logo';
